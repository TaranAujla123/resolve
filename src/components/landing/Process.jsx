...
import { ShieldCheck, ClipboardList, KeySquare, ChevronDown } from 'lucide-react'
        ...
        {steps.map((s, i) => {
          ...
          return (
            <React.Fragment key={s.n}>
              ...
              {i < steps.length - 1 && (
                <li
                  className="flex justify-center items-center md:hidden -my-1.5"
                  aria-hidden="true"
                >
                  <ChevronDown className="h-6 w-6 text-accent" strokeWidth={1.75} />
                </li>
              )}
            </React.Fragment>
          )
