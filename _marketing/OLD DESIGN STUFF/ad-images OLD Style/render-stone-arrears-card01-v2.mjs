#!/usr/bin/env node
/**
 * Render a single replacement card 1 for the WINNING stone-background
 * Arrears carousel ("Arrears Carousel - Stone back").
 *
 * Original card 1 image text: "Mortgage situations have a window. /
 * Options live inside it." — flagged by Taran as cryptic.
 *
 * Replacement (matches the navy carousel's strong card 1 hook + same
 * stone-background design as the existing cards 2-5 so the carousel
 * stays visually consistent):
 *   Hook: "Missed a mortgage payment?"
 *   Sub:  "You still have options."
 *
 * Style mirrors render-stone-carousels.mjs exactly — eyebrow + slide
 * counter top row, big serif hook, bronze italic sub, Resolve footer
 * with brokerage attribution.
 *
 * Output (1080×1080 PNG):
 *   public/ads/carousels/stone-arrears-01-missed-payment-v2.png
 */
...
const SLIDE = {
  ...
  sub: 'You still have options.',
  outName: 'stone-arrears-01-missed-payment-v2.png',
}
...
async function run() {
  ...
  console.log('[stone-arrears-card01-v2] launching puppeteer')
